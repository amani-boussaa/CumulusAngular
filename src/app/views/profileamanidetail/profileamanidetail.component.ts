...
@Component({
  selector: 'app-profileamanidetail',
  templateUrl: './profileamanidetail.component.html',
  styleUrls: ['./profileamanidetail.component.css']
})
export class ProfileamanidetailComponent implements OnInit {
